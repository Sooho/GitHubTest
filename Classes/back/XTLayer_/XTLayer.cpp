...
// Override of touches
void XTLayer::onTouchesBegan(cocos2d::CCSet* _touches, cocos2d::CCEvent* event)
{
...
void XTLayer::onTouchesMoved(cocos2d::CCSet* _touches, cocos2d::CCEvent* event)
{
...
void XTLayer::onTouchesEnded(cocos2d::CCSet* _touches, cocos2d::CCEvent* event)
{
